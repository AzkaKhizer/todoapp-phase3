    ...
    <AuthProvider>
      <div className="min-h-screen bg-gradient-radial noise relative overflow-hidden flex items-center justify-center p-4 sm:p-6">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/3 left-1/4 w-64 h-64 sm:w-96 sm:h-96 bg-gradient-glow rounded-full blur-3xl animate-pulse-slow" />
          <div className="absolute bottom-1/4 right-1/3 w-56 h-56 sm:w-80 sm:h-80 bg-gradient-glow rounded-full blur-3xl animate-pulse-slow delay-200" />
        </div>
